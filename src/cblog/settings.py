...
DATABASES = {
    'default': {
        ...
        'NAME': 'capstone-rds', # database name in RDS is written here
        'USER': 'admin', # database master username in RDS is written here
        'PASSWORD': config('PASSWORD'), # database master password in RDS is written here
        'HOST': 'capstone-rds.cte6oaeyohc7.eu-central-1.rds.amazonaws.com',  # database endpoint is written here
...
AWS_STORAGE_BUCKET_NAME = 'clarusway-blog-media-selin' # please enter your s3 bucket name
